...
<div class="flex flex-col rounded-lg bg-white shadow-lg dark:bg-neutral-700 md:flex-row">
    ...
    <div class="flex items-center justify-center h-24 md:h-full w-full md:w-32 rounded-t-lg md:rounded-none md:rounded-l-lg bg-linear-to-br from-cyan-500/50 to-blue-500/50">
        <div>
    ...
    <div class="flex items-center justify-center h-24 md:h-full w-full md:w-32 rounded-t-lg md:rounded-none md:rounded-l-lg bg-linear-to-br from-rose-500/50 to-red-500/50">
        <div>
    ...
    @else
    <div class="flex items-center justify-center h-24 md:h-full w-full md:w-32 rounded-t-lg md:rounded-none md:rounded-l-lg bg-linear-to-br from-amber-400/50 to-yellow-500/50">
        <div>
