        ...
        <div class="flex justify-between h-8.5">
            ...
            <div class="inline-flex">
                <form method="get" action="{{ route('service.search') }}">
                    ...
                    <x-select-input id="source_language" name="source_language" class="mt-1 block w-full">
                    ...
                    <x-select-input id="target_language" name="target_language" class="mt-1 block w-full">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="flex flex-col rounded-lg bg-white shadow-lg dark:bg-neutral-700 md:max-w-xl md:flex-row">
                    ...
                    <div class="flex items-center justify-center h-full w-32 rounded-t-lg md:rounded-none md:rounded-l-lg bg-gradient-to-br from-cyan-500/50 to-blue-500/50">
                        <div>
                    ...
                    <div class="flex items-center justify-center h-full w-32 rounded-t-lg md:rounded-none md:rounded-l-lg bg-gradient-to-br from-rose-500/50 to-red-500/50">
                        <div>
                    ...
                    @else
                    <div class="flex items-center justify-center h-full w-32 rounded-t-lg md:rounded-none md:rounded-l-lg bg-gradient-to-br from-amber-400/50 to-yellow-500/50">
                        <div>
                    ...
                    <div class="flex flex-col justify-between w-4/5 p-6">
                        <div>
